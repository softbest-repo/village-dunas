				...
				<div id="filtro">
					...
					<div class="demoTarget">
						<div id="formulario-filtro">
							...
							<form name="filtro" action="<?php echo $configUrl;?>cadastros/quadras/" method="post" />
...
?>				
						...
						<br/>
						<form action="<?php echo $configUrlGer; ?>cadastros/quadras/" method="post">
...
?>
								...
								<tr class="tr">
									<td class="oitenta"><a href='<?php echo $configUrlGer; ?>cadastros/quadras/alterar/<?php echo $dadosQuadra['codQuadra'] ?>/' title='Veja os detalhes da quadra <?php echo $dadosQuadra['nomeQuadra'] ?>'><?php echo $dadosQuadra['nomeQuadra'];?></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>cadastros/quadras/alterar/<?php echo $dadosQuadra['codQuadra'] ?>/' title='Deseja alterar a quadra <?php echo $dadosQuadra['nomeQuadra'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
