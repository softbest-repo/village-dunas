...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>cadastros/usuarios/ativacao/<?php echo $dadosNomeUsuario['codUsuario'] ?>/' title='Deseja <?php echo $statusPergunta ?> o usuário <?php echo $dadosNomeUsuario['nomeUsuario'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
					...
					<div class="botao-consultar"><a href="<?php echo $configUrl;?>cadastros/usuarios/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
<?php
				if(isset($_POST['alterar'])){
					...
					if($registrosNome == 0 || $registrosNome >= 1){		
						...
						if($registros == 0){
							if($_POST['senha'] == $_POST['confirma-senha']){
								...
								if($filtraUsuario == ""){
									$sql = "UPDATE usuarios SET codFilial = ".$_POST['filial'].", nomeUsuario = '".preparaNome($_POST['nome'])."', dataCadastro = '".$_POST['dataCadastro']."', sobrenomeUsuario = '".preparaNome($_POST['sobrenome'])."', tipoUsuario = '".$_POST['tipo-usuario']."', leadsUsuario = '".$_POST['leads-usuario']."', ruaUsuario = '".$_POST['rua']."', numeroUsuario = '".$_POST['numero']."', bairroUsuario = '".$_POST['bairro']."', codCidade = '".$_POST['cidade']."', codEstado = '".$_POST['estado']."', telefoneUsuario = '".$_POST['telefone']."', celularUsuario = '".$_POST['celular']."', emailUsuario = '".$_POST['email']."', cpfUsuario = '".$_POST['cpf']."', rgUsuario = '".$_POST['rg']."', sexoUsuario = '".$_POST['sexo']."', usuarioUsuario = '".$_POST['usuario']."', senhaUsuario = '".base64_encode($_POST['senha'])."' WHERE codUsuario = '".$url[6]."'";
								}else{
									$sql = "UPDATE usuarios SET codFilial = ".$_POST['filial'].", nomeUsuario = '".preparaNome($_POST['nome'])."', dataCadastro = '".$_POST['dataCadastro']."', sobrenomeUsuario = '".preparaNome($_POST['sobrenome'])."', ruaUsuario = '".$_POST['rua']."', numeroUsuario = '".$_POST['numero']."', bairroUsuario = '".$_POST['bairro']."', codCidade = '".$_POST['cidade']."', codEstado = '".$_POST['estado']."', telefoneUsuario = '".$_POST['telefone']."', celularUsuario = '".$_POST['celular']."', emailUsuario = '".$_POST['email']."', cpfUsuario = '".$_POST['cpf']."', rgUsuario = '".$_POST['rg']."', sexoUsuario = '".$_POST['sexo']."', usuarioUsuario = '".$_POST['usuario']."', senhaUsuario = '".base64_encode($_POST['senha'])."' WHERE codUsuario = '".$url[6]."'";
								}
					...
					$_SESSION['filial'] = $dadosUsuario['codFilial'];
					$_SESSION['tipo-usuario'] = $dadosUsuario['tipoUsuario'];
					$_SESSION['leads-usuario'] = $dadosUsuario['leadsUsuario'];
...
?>
								...
								document.getElementById("tipo-usuario1").disabled = false;
								document.getElementById("tipo-usuario2").disabled = false;
								document.getElementById("leads-usuario").disabled = false;
								document.getElementById("leads-usuario2").disabled = false;
<?php
				}
?>								
						...
						<br/>
						<form name="formUsuarioes" action="<?php echo $configUrlGer; ?>cadastros/usuarios/alterar/<?php echo $url[6] ;?>/" method="post">
							...
							<input id="nome" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="nome" style="width:200px;" required value="<?php echo $_SESSION['nome']; ?>" /></p>
						
							<p class="bloco-campo-float"><label>Sobrenome: <span class="obrigatorio"> * </span></label>
							<input id="sobrenome" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="sobrenome" style="width:200px;" required value="<?php echo $_SESSION['sobrenome']; ?>" /></p>

							<p class="bloco-campo-float"><label>Filial: <span class="obrigatorio"> * </span></label>
								<select class="campo" id="filial" name="filial" style="width:150px;" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> required >
...
?>
									<option value="<?php echo $dadosFilial['codFilial'] ;?>" <?php echo $_SESSION['filial'] == $dadosFilial['codFilial'] ? '/SELECTED/' : '';?>><?php echo $dadosFilial['nomeFilial'] ;?></option>
<?php
				}
?>					
								</select>
							...
							<input class="caixa" name="tipo-usuario" id="tipo-usuario2" type="radio" value="A" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> <?php echo $_SESSION['tipo-usuario'] == "A" || $_SESSION['tipo-usuario'] == "" ? 'checked' : ''; ?> />Administrador   <input class="caixa" name="tipo-usuario" id="tipo-usuario" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> type="radio" value="C" <?php echo $_SESSION['tipo-usuario'] == 'C' ? 'checked' : ''; ?> />Corretor <input class="caixa" name="tipo-usuario" id="tipo-usuario1" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> type="radio" value="CE" <?php echo $_SESSION['tipo-usuario'] == 'CE' ? 'checked' : ''; ?> />Corretor Externo</p>	
							...
							<input id="bairro" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="bairro" style="width:145px;" value="<?php echo $_SESSION['bairro']; ?>"/></p>
...
?>
							...
							<input id="cpf" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="cpf" style="width:200px;" value="<?php echo $_SESSION['cpf']; ?>"   onKeyDown="Mascara(this,Cpf);" onKeyPress="Mascara(this,Cpf);" onKeyUp="Mascara(this,Cpf)"/></p>

							<p class="bloco-campo-float"><label>RG:</label>
							<input id="rg" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="rg" style="width:145px;" value="<?php echo $_SESSION['rg']; ?>"/></p>
							...
							<input class="caixa" name="leads-usuario" id="leads-usuario2" type="radio" value="S" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> <?php echo $_SESSION['leads-usuario'] == "S" || $_SESSION['leads-usuario'] == "" ? 'checked' : ''; ?> />Sim   <input class="caixa" name="leads-usuario" id="leads-usuario" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> type="radio" value="N" <?php echo $_SESSION['leads-usuario'] == 'N' ? 'checked' : ''; ?> />Não</p>	

							<p class="bloco-campo-float"><label>E-mail: </label>
							<input id="email" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="email" name="email" style="width:200px;" value="<?php echo $_SESSION['email']; ?>"/></p>
							
							<p class="bloco-campo-float"><label>Usuário: <span class="obrigatorio"> * </span></label>
							<input id="usuario" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="usuario" required style="width:120px;" value="<?php echo $_SESSION['usuario']; ?>" /></p>

							<div class="bloco-campo-float"><label>Senha: <span class="obrigatorio"> * </span></label>
								<input id="senha" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="password" name="senha" required style="width:120px;" onkeyUp="checa_seguranca('senha', 'pass'), checa_seguranca_nome('senha', 'pass2');"  onkeydown="javascript:mostraBloco('bloco-pass');" value="<?php echo $_SESSION['senha']; ?>"/><br/>
							...
							<input id="senha2" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="password" name="confirma-senha" style="width:120px;" required onBlur="confere()" value="<?php echo $_SESSION['confirma-senha']; ?>" />
								<div id="compara"></div>
								<br class="clear" />
							</div>
							<br class="clear" />
