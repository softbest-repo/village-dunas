...
?>
				...
				<div id="filtro">
					<div id="localizacao-filtro">
						...
						<p style="margin-top:15px;" class="nome-lista">Movimentações</p>
						<br class="clear" />
					</div>
					<div class="demoTarget">
						<div id="formulario-filtro" style="width:auto; float:left;">
							...
							<div class="por-mes" style="float:left; margin-right:20px;">	
								<br class="clear"/>
								<form name="filtro" action="<?php echo $configUrl;?>relatorios/movimentacoes/" method="post" >
						...
						<div id="imprime-requisicao" style="width:800px; padding-top:20px; padding-bottom:20px; margin:0 45px auto;">
							<div style="width:800px; margin:0 auto;">
								...
								<div id="topo-requisicao" style="width:800px; border-bottom:2px solid #000000;">	
									...
									<p class="titulo-requisicao" style="text-align:center; padding-bottom:10px; padding-top:5px; margin:0; font-size:24px; font-family:Arial; font-weight:bold;"><?php echo $nomeEmpresaMenor;?> - Relatório Movimentações</p>
								</div>
								<div id="conteudo-requisicao" style="width:800px; overflow-y:auto; margin-top:40px;">
									<div id="mostra-dados" style="width:100%;">
										<div id="nomes" style="width:100%; margin-bottom:15px;">
											<p style="width:67%; float:left; margin:0; padding:1%; font-size:16px; font-family:Arial; font-weight:bold; text-align:center; border:1px dashed #000;">Contas</p>
											<p style="width:28%; float:left; margin:0; padding:1%; font-size:16px; font-family:Arial; font-weight:bold; text-align:center; border:1px dashed #000; border-left:none;">Valor</p>
											<br style="clear:both;"/>
										</div>
<?php	
					$totalRP = 0; 
					
					$sqlContaR = "SELECT SUM(CP.valorContaParcial) total FROM contasParcial CP inner join contas C on CP.codConta = C.codConta WHERE C.areaPagamentoConta = 'R' and CP.dataContaParcial >= '".$_SESSION['data1']."' and CP.dataContaParcial <= '".$_SESSION['data2']."'";
					$resultContaR = $conn->query($sqlContaR);
					$dadosContaR = $resultContaR->fetch_assoc();
					
					$sqlContaP = "SELECT SUM(CP.valorContaParcial) total FROM contasParcial CP inner join contas C on CP.codConta = C.codConta WHERE C.areaPagamentoConta = 'P' and CP.dataContaParcial >= '".$_SESSION['data1']."' and CP.dataContaParcial <= '".$_SESSION['data2']."'";
...
?>
										...
										<div id="clientes" style="width:100%; margin-bottom:10px;">
											<p style="width:70%; float:left; margin:0; font-size:16px; font-family:Arial; color:#0000FF; text-align:center;">Contas Recebidas</p>
											<p style="width:30%; float:left; margin:0; font-size:16px; font-family:Arial; color:#0000FF; text-align:center;">R$ <?php echo number_format($dadosContaR['total'], 2, ",", ".");?></p>
											<br style="clear:both;"/>
										</div>
										<div id="clientes" style="width:100%; margin-bottom:10px;">
											<p style="width:70%; float:left; margin:0; font-size:16px; font-family:Arial; color:#FF0000; text-align:center;">Contas Pagas</p>
											<p style="width:30%; float:left; margin:0; font-size:16px; font-family:Arial; color:#FF0000; text-align:center;">R$ <?php echo number_format($dadosContaP['total'], 2, ",", ".");?></p>
											<br style="clear:both;"/>
										</div>
										...
										<br/>
										<br/>
										<p style="margin:0px; padding:0px; font-size:20px; text-align:center; text-decoration:underline; font-family:Arial; padding-bottom:20px; font-weight:bold;">Contas Recebidas</p>
										<div id="nomes" style="width:100%; margin-bottom:15px;">
											<p style="width:27%; float:left; margin:0; padding:1%; font-size:15px; font-family:Arial; font-weight:bold; text-align:center; border:1px dashed #000;">Cliente</p>
											<p style="width:28%; float:left; margin:0; padding:1%; font-size:15px; font-family:Arial; font-weight:bold; text-align:center; border:1px dashed #000; border-left:none;">Tipo Pagamento</p>
											<p style="width:18%; float:left; margin:0; padding:1%; font-size:15px; font-family:Arial; font-weight:bold; text-align:center; border:1px dashed #000; border-left:none;">Data de Cadastro</p>
											<p style="width:18%; float:left; margin:0; padding:1%; font-size:15px; font-family:Arial; font-weight:bold; text-align:center; border:1px dashed #000; border-left:none;">Valor</p>
											<br style="clear:both;"/>
										</div>
<?php
					$totalRS = 0;
					
					$sqlContaRS = "SELECT * FROM contasParcial CP inner join contas C on CP.codConta = C.codConta WHERE C.areaPagamentoConta = 'R' and CP.dataContaParcial >= '".$_SESSION['data1']."' and CP.dataContaParcial <= '".$_SESSION['data2']."' ORDER BY CP.dataContaParcial ASC";
					...
					while($dadosContaRS = $resultContaRS->fetch_assoc()){
						...
						$totalRS = $totalRS + $dadosContaRS['valorContaParcial'];		
?>
										<div id="clientes" style="width:100%; margin-bottom:10px;">
											...
											<p style="width:20%; float:left; margin:0; font-size:14px; font-family:Arial; text-align:center;"><?php echo data($dadosContaRS['dataContaParcial']);?></p>
											<p style="width:20%; float:left; margin:0; font-size:14px; font-family:Arial; text-align:center;">R$ <?php echo number_format($dadosContaRS['valorContaParcial'], 2, ",", ".");?></p>
											<br style="clear:both;"/>
										</div>
<?php
					}
?>
										<p style="padding:0px; margin:0px; padding-top:5px; margin-top:20px; border-top:1px solid #000;"></p>
										<p style="padding:0px; margin:0px; width:20%; text-align:center; font-family:Arial; font-size:16px; float:right;"><strong>Total:</strong><br/>R$ <?php echo number_format($totalRS, 2, ",", ".");?></p>
										<br style="clear:both;"/>
										<p style="padding:0px; margin:0px; margin-top:5px; border-bottom:1px solid #000;"></p>
										<br/>
										<br/>
										<br/>
										<p style="margin:0px; padding:0px; font-size:20px; text-align:center; text-decoration:underline; font-family:Arial; padding-bottom:20px; font-weight:bold;">Contas Pagas</p>
										<div id="nomes" style="width:100%; margin-bottom:15px;">
											<p style="width:27%; float:left; margin:0; padding:1%; font-family:Arial; font-size:15px; font-weight:bold; text-align:center; border:1px dashed #000;">Fornecedor</p>
											<p style="width:28%; float:left; margin:0; padding:1%; font-family:Arial; font-size:15px; font-weight:bold; text-align:center; border:1px dashed #000; border-left:none;">Tipo Pagamento</p>
											<p style="width:18%; float:left; margin:0; padding:1%; font-family:Arial; font-size:15px; font-weight:bold; text-align:center; border:1px dashed #000; border-left:none;">Data de Cadastro</p>
											<p style="width:18%; float:left; margin:0; padding:1%; font-family:Arial; font-size:15px; font-weight:bold; text-align:center; border:1px dashed #000; border-left:none;">Valor</p>
											<br style="clear:both;"/>
										</div>
<?php
					$totalPS = 0;
					
					$sqlContaPS = "SELECT * FROM contasParcial CP inner join contas C on CP.codConta = C.codConta WHERE C.areaPagamentoConta = 'P' and CP.dataContaParcial >= '".$_SESSION['data1']."' and CP.dataContaParcial <= '".$_SESSION['data2']."' ORDER BY CP.dataContaParcial ASC";
					...
					while($dadosContaPS = $resultContaPS->fetch_assoc()){
						...
						$totalPS = $totalPS + $dadosContaPS['valorContaParcial'];	
?>
										<div id="clientes" style="width:100%; margin-bottom:10px;">
											...
											<p style="width:30%; float:left; margin:0; font-size:14px; font-family:Arial; text-align:center;"><?php echo $dadosTipoPagamento['nomeTipoPagamento'];?></p>
											<p style="width:20%; float:left; margin:0; font-size:14px; font-family:Arial; text-align:center;"><?php echo data($dadosContaPS['dataContaParcial']);?></p>
											<p style="width:20%; float:left; margin:0; font-size:14px; font-family:Arial; text-align:center;">R$ <?php echo number_format($dadosContaPS['valorContaParcial'], 2, ",", ".");?></p>
											<br style="clear:both;"/>
										</div>
<?php
					}
...
<?php	
				...
				$sqlContaR = "SELECT SUM(valorContaParcial) total FROM contasParcial CP inner join contas C on CP.codConta = C.codConta WHERE C.areaPagamentoConta = 'R' and CP.dataContaParcial >= '".$_SESSION['data1']."' and CP.dataContaParcial <= '".$_SESSION['data2']."'";
				$resultContaR = $conn->query($sqlContaR);
				$dadosContaR = $resultContaR->fetch_assoc();
				
				$sqlContaP = "SELECT SUM(valorContaParcial) total FROM contasParcial CP inner join contas C on CP.codConta = C.codConta WHERE C.areaPagamentoConta = 'P' and CP.dataContaParcial >= '".$_SESSION['data1']."' and CP.dataContaParcial <= '".$_SESSION['data2']."'";
				$resultContaP = $conn->query($sqlContaP);
				$dadosContaP = $resultContaP->fetch_assoc();
...
?>
								...
								<tr class="tr">
									<td class="oitenta" style="text-align:center; color:#0000FF; font-size:18px;">Contas Recebidas</a></td>
									<td class="vinte" style="text-align:center; color:#0000FF; font-size:18px;">R$ <?php echo number_format($dadosContaR['total'], 2, ",", ".");?></a></td>
								</tr>
								<tr class="tr">
									<td class="oitenta" style="text-align:center; color:#FF0000; font-size:18px;">Contas Pagas</a></td>
						...
						<div id="col-dir-receber" style="width:100%;">
							<p class="titulo-receber" style="font-size:22px; text-align:center; padding-bottom:15px; font-weight:bold; color:#718B8F;">Contas Recebidas</p>
							<table class="tabela-menus" >
								<tr class="titulo-tabela" border="none">
...
?>
								...
								<tr class="tr">
									...
									<td class="vinte" style="text-align:center;"><?php echo data($dadosContaRS['dataContaParcial']);?></a></td>
									<td class="vinte" style="text-align:center;">R$ <?php echo number_format($dadosContaRS['valorContaParcial'], 2, ",", ".");?></a></td>
								</tr>
<?php
				}
?>							 
						...
						<br/>
						<div id="col-dir-receber" style="width:100%;">
							<p class="titulo-receber" style="font-size:22px; text-align:center; padding-bottom:15px; font-weight:bold; color:#718B8F;">Contas Pagas</p>
							<table class="tabela-menus" >
								<tr class="titulo-tabela" border="none">
...
?>
								...
								<tr class="tr">
									...
									<td class="trinta" style="text-align:center;"><?php echo $dadosTipoPagamento['nomeTipoPagamento'];?></a></td>
									<td class="vinte" style="text-align:center;"><?php echo data($dadosContaPS['dataContaParcial']);?></a></td>
									<td class="vinte" style="text-align:center;">R$ <?php echo number_format($dadosContaPS['valorContaParcial'], 2, ",", ".");?></a></td>
								</tr>
<?php
				}
?>							 
