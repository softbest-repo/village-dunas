...
?>
				...
				<div id="filtro">
					<div id="localizacao-filtro">
						...
						<p style="margin-top:15px;" class="nome-lista">Fornecedores</p>
						<br class="clear" />
					</div>
					<div class="demoTarget">
						<div id="formulario-filtro" style="width:auto; float:left;">
							...
							<div class="por-mes" style="float:left; margin-right:20px;">	
								<br class="clear"/>
								<form name="filtro" action="<?php echo $configUrl;?>relatorios/fornecedores/" method="post" >
						...
						<div id="imprime-requisicao" style="width:800px; padding-top:20px; padding-bottom:20px; margin:0 45px auto;">
							<div style="width:800px; margin:0 auto;">
								...
								<div id="topo-requisicao" style="width:800px; border-bottom:2px solid #000000;">	
									...
									<p class="titulo-requisicao" style="text-align:center; padding-bottom:10px; padding-top:5px; margin:0; font-family:Arial; font-size:24px; font-weight:bold;"><?php echo $nomeEmpresaMenor;?> - Relatório Fornecedores</p>
								</div>
								<div id="conteudo-requisicao" style="width:800px; overflow-y:auto; margin-top:40px;">
									<div id="mostra-dados" style="width:100%;">
										<div id="nomes" style="width:100%; margin-bottom:15px;">
											<p style="width:67%; float:left; margin:0; padding:1%; font-size:15px; font-weight:bold; text-align:center; font-family:Arial; border:1px dashed #000;"><?php echo data($_SESSION['data1']);?> á <?php echo data($_SESSION['data2']);?></p>
											<p style="width:28%; float:left; margin:0; padding:1%; font-size:15px; font-weight:bold; text-align:center; font-family:Arial; border:1px dashed #000; border-left:none;">Valor</p>
											<br style="clear:both;"/>
										</div>
<?php				
					$totalRS = 0;
					
					$sqlFornecedor = "SELECT * FROM fornecedores ORDER BY nomeFornecedor ASC";
					$resultFornecedor = $conn->query($sqlFornecedor);
					while($dadosFornecedor = $resultFornecedor->fetch_assoc()){
					
						$sqlContaRS = "SELECT SUM(vParcela) total FROM contas WHERE baixaConta = 'T' and codFornecedor = ".$dadosFornecedor['codFornecedor']." and areaPagamentoConta = 'P' and dataCConta >= '".$_SESSION['data1']."' and dataCConta <= '".$_SESSION['data2']."' ORDER BY dataCConta ASC";
...
?>
										<div id="clientes" style="width:100%; margin-bottom:10px;">
											<p style="width:70%; float:left; margin:0; font-size:14px; font-family:Arial; text-align:center;"><?php echo $dadosFornecedor['nomeFornecedor'];?></p>
...
?>
										...
										<p style="padding:0px; margin:0px; width:30%; text-align:center; font-size:16px; font-family:Arial; float:right;"><strong>Total:</strong><br/>R$ <?php echo number_format($totalRS, 2, ",", ".");?></p>
										<br style="clear:both;"/>
...
?>
								...
								<tr class="tr">
									<td class="oitenta" style="text-align:center;"><?php echo $dadosFornecedor['nomeFornecedor'];?></a></td>
