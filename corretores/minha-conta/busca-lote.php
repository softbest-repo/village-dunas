			...
			if ($entrada != "0.00" && !empty($parcelas) && $valorFinanciado != "0.00") {
				foreach ($parcelasArray as $parcela) {
					if($dadosLoteamento['reforcoLoteamento'] != "0.00"){
						...
						$taxaReforco = $reforco * $dadosLoteamento['reforcoLoteamento'];
						...
						$valorTotalTaxa = $valorParcela * $parcela;
						$totalSemReforco = $valorTotalTaxa - $valorReforco;
						$valorParcela = $totalSemReforco / $parcela;
						...
						if($contaArray == 1){
							$parcelasString = "R$ ".$valorParcela;
						}else{
							$parcelasString .= "<br/>R$ ".$valorParcela." (".$parcela."x)";						
						}
