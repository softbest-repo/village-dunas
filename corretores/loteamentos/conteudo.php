...
<?php
	...
	$sqlLoteamentos = "SELECT * FROM loteamentos L inner join loteamentosImagens LI on L.codLoteamento = LI.codLoteamento WHERE L.statusLoteamento = 'T'".$filtraCidade.$filtraLoteamento." GROUP BY L.codLoteamento ORDER BY L.codOrdenacaoLoteamento ASC";
